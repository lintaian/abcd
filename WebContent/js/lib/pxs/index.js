window.onload = function()
{
	...
	for(var i=0;i<aImg_sm.length;i++)
	{
		...
		{
			iNow = this.index;
			startMove(aImg_sm[this.index], {opacity:100,marginTop:-20,zIndex: 1});
		}
		aImg_li[i].onmouseout = function()
		{
			startMove(aImg_sm[this.index], {opacity:70,marginTop:0,zIndex: 0});
		}
		...
		oNext.onclick = function()
		{
			...
			for(var i=0;i<aImg_sm.length;i++)
			{
				startMove(aImg_sm[i], {opacity:70,marginTop:0,zIndex: 0});
			}
			
			startMove(aImg_sm[iNow], {opacity:100,marginTop:-20,zIndex: 1});
		}
	}
}