...
<body data-unit-code="${obj.unitCode }" data-top>
	...
	<div class="main">
		<iframe src="markingOnTpl?type=${obj.type}&value=${obj.value}&unitCode=${obj.unitCode}&childTypeCode=${obj.childTypeCode}&unitTypeName=${obj.unitTypeName}&batchCode=${obj.batchCode}&examName=${obj.examName}" 
			id="frame" width="100%" height="600" scrolling="false" frameborder="0"></iframe>
	</div>
